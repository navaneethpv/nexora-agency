                    ...
                    <div className="glass-card rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden group">
                        <div className="flex flex-col md:flex-row justify-between gap-10 relative z-10">
                            <div className="space-y-6 flex-1">
                                <div>
                                    <h3 className="text-3xl font-bold mb-3">A performance-first mindset</h3>
                                    <p className="text-secondary text-lg font-medium leading-relaxed">We don't just build sites; we build high-performance assets for your business.</p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center gap-3">
                                            ...
                                            <span className="text-secondary text-sm font-bold">{point}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className="bg-black/40 backdrop-blur-xl border border-white/5 p-8 rounded-[2rem] w-full md:w-[320px] flex flex-col items-center justify-center text-center">
                                ...
                                <button className="w-full bg-accent text-white py-4 rounded-2xl font-bold text-sm hover:brightness-110 transition-all shadow-lg shadow-accent/20 mb-4">
                                    Get started
                                </button>
                                <button className="text-secondary text-[11px] font-bold uppercase tracking-widest hover:text-white transition-colors">
                                    Book a call
                                </button>
                            </div>
                        </div>
