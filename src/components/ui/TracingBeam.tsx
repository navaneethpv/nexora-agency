        ...
        >
            <div className="absolute -left-4 md:-left-20 top-3">
                <motion.div
                    ...
                    className="ml-[27px] h-4 w-4 rounded-full border border-white/10 shadow-sm flex items-center justify-center bg-black"
                >
                    <motion.div
                        transition={{
                            duration: 0.2,
                ...
                >
                    ...
                    <defs>
                        ...
                        >
                            ...
                            <stop stopColor="#0A7FD9"></stop>
                            <stop stopColor="#0A7FD9" stopOpacity="0"></stop>
                        </motion.linearGradient>
                    </defs>
                </svg>
            </div>
